...
def test_if_returns_thumbnail_and_full_size_if_both_exist(app):
...
def test_if_get_thumbnail_returns_empty_if_no_sizes_in_metadata(app):
    ...
    result = thumbnails.get_thumbnail_url(metadata, '2018/06/1529158588942b5.jpg')
    assert result == '2018/06/1529158588942b5.jpg'
...
def test_if_get_thumbnail_returns_properly(app):
    ...
    result = thumbnails.get_thumbnail_url(metadata, '2018/06/1529158588942b5.jpg')
    assert result == '2018/06/1529158588942b5-150x150.jpg'